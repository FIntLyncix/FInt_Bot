...
/*
//Chargement des fonctions du bot//
fs.readdir('./free_script/', (error, f) => {
    if (error) console.log(error);

    console.log("======Free script======");

    console.log(`${f.length} free script en chargement`);

    f.forEach((f) => {
        const events = require(`./free_script/${f}`);

        events.fonctions(bot);
